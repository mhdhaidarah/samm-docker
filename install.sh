...
# Generated for SAMM v4.1.12.
#
#   curl -fsSL https://github.com/mhdhaidarah/samm-docker/releases/download/v4.1.12/install.sh | sudo bash
#
# What this does:
#   1. Verify root + supported OS (Ubuntu/Debian)
#   2. Install Docker engine + compose plugin if missing
#   3. Create /opt/samm-docker/
#   4. Download docker-compose.yml for SAMM v4.1.12
